        ...
        <p>Enter Home Works</p>       
		  ...
		  <?php
			...
			while($query_execute=mysqli_fetch_assoc($is_query_run)){
				echo"<tr><td>".$query_execute["no"]."</td><td>".$query_execute["hw_description"]."</td><td><a href=\"../Student/DashboardPage/HomeWorks/hws/h1\">click<a></td></tr>";		
			}
			echo"</table>";
		  ...
		  ?>
		  <form action="DashboardPage\HomeWorks\hwupload.php" method="get" enctype="multipart/form-data" >
            <p><span>Enter the homework</span><input class="contact" type="text" name="info" value="" /></p>
